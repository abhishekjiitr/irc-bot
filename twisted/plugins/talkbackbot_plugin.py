...
class TalkBackBotService(Service):
	...
	def startService(self):
		...
		factory = TalkbackBotFactory(self._channel, self._nickname, self._realname, quotes, self._triggers)
...
class BotServiceMaker(object):
	tapname = "twsrs"
	description = "Intelligent IRC Bot"
	options = Options

	def makeService(self, options):
		"""Construct the talkback service"""
		config = ConfigParser()
